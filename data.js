export const adviceData = [
    {
        "id": 1,
        "en": "Learn how to learn from those you disagree with or even offend you. See if you can find the truth in what they believe.",
        "zh": "学会向那些你不同意甚至冒犯你的人学习。看看你是否能在他们的信念中发现真理。"
    },
    {
        "id": 2,
        "en": "Being enthusiastic is worth 25 IQ points.",
        "zh": "热情相当于提高25点智商。"
    },
    {
        "id": 3,
        "en": "Listening well is a superpower. While listening to someone you love keep asking them “Is there more?” until there is no more.",
        "zh": "善于倾听是一种超级能力。当你聆听你爱的人时，持续地问“还有吗？”直到真的没有为止。"
    },
    {
        "id": 4,
        "en": "Always demand a deadline because it weeds out the extraneous and the ordinary. A deadline prevents you from trying to make it perfect so you have to make it different. Different is better.",
        "zh": "总是要求有最后期限，因为它能筛除多余和平庸的东西。截止日期会阻止你追求完美，而促使你追求创新。不同往往更好。"
    },
    {
        "id": 5,
        "en": "Don’t be afraid to ask a question that may sound stupid because 99% of the time everyone else is thinking of the same question and is too embarrassed to ask it.",
        "zh": "不要害怕问一个看起来愚蠢的问题，因为99%的时候，其他人也在想同样的问题，只是不好意思开口。"
    },
    {
        "id": 6,
        "en": "Prototype your life. Try stuff instead of making grand plans.",
        "zh": "把你的人生当作原型，去尝试各种事情，而不是空想宏伟计划。"
    },
    {
        "id": 7,
        "en": "When you forgive others they may not notice but you will heal. Forgiveness is not something we do for others; it is a gift to ourselves.",
        "zh": "当你原谅别人时，他们可能毫无察觉，但你会疗愈自己。宽恕不是给别人的，而是送给自己的礼物。"
    },
    {
        "id": 8,
        "en": "The fact that you “can’t do” something can be embarrassing. But if you are “learning to do” something that is admirable. There are only tiny baby steps between can’t and learning.",
        "zh": "意识到自己“不会做”某事可能让人尴尬。但如果你正在“学习去做”，那就是值得赞赏的。从不会到学习，其实只是小小一步。"
    },
    {
        "id": 9,
        "en": "Don’t measure your life with someone else’s ruler.",
        "zh": "不要用别人的尺子衡量自己的人生。"
    },
    {
        "id": 10,
        "en": "When someone tells you what ticks them off they are telling you what makes them tick.",
        "zh": "当别人告诉你什么让他们生气时，他们其实是在告诉你什么真正驱动着他们。"
    },
    {
        "id": 11,
        "en": "Collecting things benefits you only if you display your collection prominently and share it in joy with others. The opposite of this is hoarding.",
        "zh": "收藏只有在你把藏品展示出来、与人分享时才有意义。否则收藏就会变成囤积。"
    },
    {
        "id": 12,
        "en": "Taking a break is not a sign of weakness but a sign of strength.",
        "zh": "休息并不是软弱的表现，而是力量的象征。"
    },
    {
        "id": 13,
        "en": "A major part of travel is to leave stuff behind. The more you leave behind the further you will advance.",
        "zh": "旅行的重要部分就是学会舍弃。你放下的越多，走得就会越远。"
    },
    {
        "id": 14,
        "en": "You don’t have to attend every argument you are invited to.",
        "zh": "你不用参与每一个被邀请的争论。"
    },
    {
        "id": 15,
        "en": "A worthy goal for a year is to learn enough about a subject so that you can’t believe how ignorant you were a year earlier.",
        "zh": "一年的有价值目标，是深入学习一个领域，以至于你无法相信一年前自己是多么无知。"
    },
    {
        "id": 16,
        "en": "You can’t reason someone out of a notion that they didn’t reason themselves into.",
        "zh": "你无法用道理说服一个不是用道理形成想法的人。"
    },
    {
        "id": 17,
        "en": "Gratitude will unlock all other virtues and is something you can get better at.",
        "zh": "感恩会开启所有其它美德，而且你可以不断提升这种能力。"
    },
    {
        "id": 18,
        "en": "When you are anxious because of your to-do list take comfort in your have-done list.",
        "zh": "当你因待办事项焦虑时，不妨看看你已经完成的清单。"
    },
    {
        "id": 19,
        "en": "Treating a person to a meal never fails and is so easy to do. It’s powerful with old friends and a great way to make new friends.",
        "zh": "请别人吃一顿饭总是有效而简单。这不仅能加深友谊，也是结交新朋友的好方法。"
    },
    {
        "id": 20,
    ...
    {
        "id": 21,
        "en": "If you are looking for something in your house and you finally find it when you’re done with it don’t put it back where you found it. Put it back where you first looked for it.",
        "zh": "如果你在家里找东西，却在用完后才找到，别把它放回原处，而是放到你最先找的地方。"
    },
    {
        "id": 22,
        "en": "Movement plus variety equals health.",
        "zh": "运动加变化等于健康。"
    },
    {
        "id": 23,
        "en": "Never use a credit card for credit. The only kind of credit, or debt that is acceptable is debt to acquire something whose exchange value is extremely likely to increase like a home. The exchange value of most things diminishes or vanishes the moment you purchase them. Don’t be in debt to losers.",
        "zh": "永远不要用信用卡来借贷。唯一可以接受的负债是为了获得那些极有可能升值的东西，比如房产。大多数物品在你买下的那一刻起，价值就会贬损或消失。别为无价值的东西借债。"
    },
    {
        "id": 24,
        "en": "A great way to understand yourself is to seriously reflect on everything you find irritating in others.",
        "zh": "理解自己的绝佳方式，是认真反思你在别人身上觉得讨厌的每一件事。"
    },
    {
        "id": 25,
        "en": "The advantage of a ridiculously ambitious goal is that it sets the bar very high so even if your effort falls short it may exceed an ordinary success.",
        "zh": "设立极高目标的优点在于，即使你的努力未能达到，也极有可能超越常规的成功。"
    },
    {
        "id": 26,
        "en": "When you give away 10% of your income you lose 10% of your purchasing power which is minor compared to the 110% increase in happiness you will gain.",
        "zh": "当你捐出你收入的10%，你失去的是10%的购买力，但你收获的幸福却会提升110%。"
    },
    {
        "id": 27,
        "en": "The best way to learn anything is to try to teach what you know.",
        "zh": "最好的学习方式，就是尝试把你所知的教给别人。"
    },
    {
        "id": 28,
        "en": "Whenever you have a choice between being right or being kind be kind. No exceptions. Don’t confuse kindness with weakness.",
        "zh": "每当你在正确与善良之间做选择时，请选择善良，无一例外。善良不是软弱。"
    },
    {
        "id": 29,
        "en": "We lack rites of passage. Create a memorable family ceremony when your child reaches legal adulthood between eighteen and twenty-one. This moment will become a significant touchstone in their life.",
        "zh": "我们缺乏成人仪式。当你的孩子成年（18-21岁）时，为他们举办一场难忘的家庭仪式。这一刻将成为他们人生中的重要里程碑。"
    },
    {
        "id": 30,
        "en": "The best way to get to yes in a negotiation is to truly understand what yes means for the other party.",
        "zh": "谈判中达成“同意”的最好方式，是真正理解对方的“同意”意味着什么。"
    },
    {
        "id": 31,
        "en": "Recipe for greatness: Become just a teeny bit better than you were last year. Repeat every year.",
        "zh": "取得成就的秘诀：每年都比上一年进步一点点，并持之以恒。"
    },
    {
        "id": 32,
        "en": "Draw to discover what you see. Write to discover what you think.",
        "zh": "通过画画去发现你所见，通过写作去明晰你的思想。"
    },
    {
        "id": 33,
        "en": "Whenever you can’t decide which path to take pick the one that produces change.",
        "zh": "当你无法决定走哪条路时，选择那个会带来变化的方向。"
    },
    {
        "id": 34,
        "en": "The quickest checkout line will be the one with the fewest people no matter the size of their carts.",
        "zh": "结账时，最快的队伍往往是人数最少的，无论他们的购物车多大。"
    },
    {
        "id": 35,
        "en": "Choose not to be outraged today.",
        "zh": "今天选择不生气。"
    },
    {
        "id": 36,
        "en": "Habit is far more dependable than inspiration. Make progress by making habits. Don’t focus on getting into shape. Focus on becoming the kind of person who never misses a workout.",
        "zh": "习惯远比灵感可靠。通过养成习惯获得进步。别把目标定在身材上，而要成为永不缺席锻炼的人。"
    },
    {
        "id": 37,
        "en": "If you are the smartest person in the room, you are in the wrong room. Hang out with, and learn from people smarter than yourself. Even better, find smart people who will disagree with you.",
        "zh": "如果你是房间里最聪明的人，你就待错了地方。和比你聪明的人在一起，并向他们学习。更好的是，找到那些会和你辩论的聪明人。"
    },
    {
        "id": 38,
        "en": "You should demand extraordinary evidence in order to believe extraordinary claims.",
        "zh": "面对非凡的主张，应要求非凡的证据。"
    },
    {
        "id": 39,
        "en": "Rule of 3 in conversation: To get to the real reason, ask a person to go deeper than what they just said. Then again, and then once more. The third time’s answer is the one closest to the truth.",
        "zh": "对话中的“三次法则”：要想追到问题的根本，就请对方再多说一点，再多说一次。第三次的答案才最接近真相。"
    },
    {
        "id": 40,
        "en": "Pros make as many mistakes as amateurs; they’ve just learned how to gracefully recover from their mistakes.",
        "zh": "专业人士和新手一样会犯很多错误，但他们学会了优雅地从错误中恢复。"
    },
    {
        "id": 41,
        "en": "Don’t be the best. Be the only.",
        "zh": "别做最优秀的，要做独一无二的那一个。"
    },
    {
        "id": 42,
        "en": "Everyone is shy. Other people are waiting for you to introduce yourself to them; they are waiting for you to send them an email; they are waiting for you to ask them on a date. Go ahead.",
        "zh": "每个人都有些害羞。别人都在等你主动介绍自己、发邮件、或提出约会。勇敢行动吧。"
    },
    {
        "id": 43,
        "en": "The more you are interested in others the more interesting they’ll find you. To be interesting, be interested.",
        "zh": "你越关心别人，别人就觉得你越有趣。想成为有趣的人，先做感兴趣的人。"
    },
    {
        "id": 44,
        "en": "Don’t take it personally when someone turns you down. Assume they are like you: busy, occupied, distracted. Try again later. It’s amazing how often a second try works.",
        "zh": "别人拒绝你，不要往心里去。假设他们只是像你一样忙碌、分心。以后再试，一次未成，二次常成。"
    },
    {
        "id": 45,
        "en": "The purpose of a habit is to remove that action from self-negotiation. You no longer expend energy deciding whether to do it. You just do it. Good habits can range from telling the truth to flossing.",
        "zh": "习惯的意义在于不再反复自我说服。你无需再纠结做不做这件事，而是自动去做。好的习惯从说实话到用牙线，包罗万象。"
    },
    {
        "id": 46,
        "en": "Promptness is a sign of respect.",
        "zh": "守时是对他人的尊重。"
    },
    {
        "id": 47,
        "en": "When you are young, spend at least 6 months to 1 year living as cheaply as you can owning as little as you possibly can eating beans and rice in a tiny room or tent. That way any time you have to risk something in the future, you won’t be afraid of the “worst-case” scenario.",
        "zh": "年轻时，至少用半年到一年，尽量节俭地生活，拥有最少的东西，住在小房间或帐篷里，吃米饭和豆子。这样以后要冒险时，你就不会惧怕“最坏的情况”。"
    },
    {
        "id": 48,
        "en": "Trust me: There is no “them.”",
        "zh": "相信我：根本没有“他们”这种人群。"
    },
    {
        "id": 49,
        "en": "Tend to the small things. More people are defeated by blisters than by mountains.",
        "zh": "关注小事。更多人是被水泡打败，而不是大山难倒的。"
    },
    {
        "id": 50,
        "en": "You lead by letting others know what you expect of them which may exceed what they themselves expect. Provide them a reputation that they can step up to.",
        "zh": "你通过让别人知道你对他们的期待来进行领导，这些期待可能超过他们对自己的预期。给予他们一个可以奋斗的声誉。"
    },
    {
        "id": 51,
        "en": "If you ask for someone’s feedback you’ll get a critic. But if instead you ask for advice you’ll get a partner.",
        "zh": "如果你向别人请求反馈，你会得到批评；但如果你请求建议，你会得到伙伴。"
    },
    {
        "id": 52,
        "en": "The Golden Rule will never fail you. It is the foundation of all other virtues.",
        "zh": "“己所不欲，勿施于人”的黄金法则永远不会让你失望，它是一切美德的基础。"
    },
    {
        "id": 53,
        "en": "To make something good, just do it. To make something great, just redo it redo it, redo it. The secret to making fine things is in remaking them.",
        "zh": "要做得好，就动手去做；要做得卓越，就重复再做、再做。精益求精的秘诀在于不断重做。"
    },
    {
        "id": 54,
        "en": "This is true: It’s hard to cheat an honest person.",
        "zh": "确实如此：很难骗到一个诚实的人。"
    },
    {
        "id": 55,
        "en": "Expand your mind by thinking with your feet on a walk or with your hand in a notebook. Think outside your brain.",
        "zh": "散步时用双脚思考，记笔记时用双手思考，发散你的思维。打破大脑的限制去思考。"
    },
    {
        "id": 56,
        "en": "At first, buy the absolute cheapest tools you can find. Upgrade the ones you use a lot. If you wind up using some tool for a job buy the very best you can afford.",
        "zh": "一开始请买最便宜的工具，频繁用到的再升级。如果某个工具长期使用，就买你能负担得起的最好的。"
    },
    {
        "id": 57,
        "en": "Shorten your to-do list by asking yourself “What is the worst that will happen if this does not get done?” Eliminate all but the disasters.",
        "zh": "给你的待办事项做减法：问自己“如果这件事情不做，最坏会怎样？”保留那些不做会导致灾难的任务，其余都删掉。"
    },
    {
        "id": 58,
        "en": "To move through a place you may not be permitted, act like you belong there.",
        "zh": "如果你要去一个可能不被允许进入的地方，就表现得像是属于那里的人。"
    },
    {
        "id": 59,
        "en": "Nothing elevates a person higher than taking responsibility for their mistakes. If you mess up, fess up. It’s astounding how powerful this ownership is.",
        "zh": "没有什么比为自己的错误负责更能让人进步。如果你搞砸了，就坦然承认。承担责任的力量令人惊异。"
    },
    {
        "id": 60,
        "en": "Hatred is a curse that does not affect the hated. It only poisons the hater. Release a grudge as if it were a poison.",
        "zh": "仇恨是一种诅咒，被恨的人不会受影响，但仇恨者会被毒害。像排毒一样释放怨恨。"
    },
    {
        "id": 61,
        "en": "Don’t take a job because it pays the most money.",
        "zh": "不要因为高薪而接受一份工作。"
    },
    {
        "id": 62,
        "en": "You can obsess about your customers or you can obsess about beating the competition. Both work, but of the two obsessing about your customers will take you further.",
        "zh": "你可以专注于你的客户，也可以专注于打败竞争对手。两者都有效，但专注客户会让你走得更远。"
    },
    {
        "id": 63,
        "en": "“No” is an acceptable answer even without a reason.",
        "zh": "即使没有理由，说“不”也完全可以。"
    },
    {
        "id": 64,
        "en": "Separate the processes of creating from improving. You can’t write and edit or sculpt and polish or make and analyze at the same time. If you do, the editor stops the creator. While you invent, don’t select. While you sketch, don’t inspect. While you write the first draft, don’t reflect. At the start, the creator mind must be unleashed from judgment.",
        "zh": "创作和完善要分开进行。你无法一边写一边改稿，或一边雕刻一边打磨，或一边创造一边分析。如果你这么做，批评者会扼杀创造者。在你构思时，不要挑选；在你草绘时，不要检视；写初稿时，不要反思。最初阶段要让创造力毫无束缚。"
    },
    {
        "id": 65,
        "en": "If you are not falling down occasionally you are just coasting.",
        "zh": "如果你从未跌倒过，说明你只是原地踏步。"
    },
    {
        "id": 66,
        "en": "Perhaps the most counterintuitive truth of the universe is that the more you give to others the more you’ll get. Understanding this is the beginning of wisdom.",
        "zh": "宇宙中最反常识的真理也许就是：你给予越多，收获也会越多。理解这一点，就是智慧的开始。"
    },
    {
        "id": 67,
        "en": "Keep showing up. 99% of success is just showing up. In fact, most success is just persistence.",
        "zh": "坚持出现。99%的成功就在于坚持出席。事实上，大多数成功就是坚持不懈。"
    },
    {
        "id": 68,
        "en": "Friends are better than money. Almost anything money can do friends can do better. In so many ways, a friend with a boat is better than owning a boat.",
        "zh": "朋友比金钱更有价值。几乎金钱能做到的事情，朋友能做得更好。有朋友有船，远胜于自己买一条船。"
    },
    {
        "id": 69,
        "en": "When an object is lost, 95% of the time it is hiding within arm’s reach of where it was last seen. Search in all possible locations in that radius and you’ll find it.",
        "zh": "当找不到东西时，95%的可能它就在离上次看到它的地方一臂之遥内。仔细搜索那个范围，你就能找到。"
    },
    {
        "id": 70,
        "en": "A vacation + a disaster = an adventure.",
        "zh": "假期加上意外等于冒险。"
    },
    {
        "id": 71,
        "en": "Don’t be in haste. When you are in a hurry you are more easily conned or manipulated.",
        "zh": "不要急躁。仓促时你更容易被骗或被操控。"
    },
    {
        "id": 72,
        "en": "Forgiveness is accepting the apology you will never get.",
        "zh": "宽恕就是接受你永远等不到的道歉。"
    },
    {
        "id": 73,
        "en": "To cultivate a habit switch your language from “I can or can’t do” to “I do or don’t do.” You shift the weight from a wavering choice to an unwavering identity.",
        "zh": "培养习惯的方法，是把“我能不能做”换成“我就是做/不做”。你会从摇摆的选择变成坚定的身份。"
    },
    {
        "id": 74,
        "en": "Be more generous than necessary. No one on their deathbed has ever regretted giving too much away. There is no point to being the richest person in the cemetery.",
        "zh": "要慷慨得超过所需。没有人临终时会后悔给出去太多。做坟墓里最富有的人毫无意义。"
    },
    {
        "id": 75,
        "en": "You need teachers, parents customers, fans, and friends because they will see who you are becoming before you will.",
        "zh": "你需要老师、父母、客户、粉丝和朋友，因为他们比你自己更早看见你正在成为谁。"
    },
    {
        "id": 76,
        "en": "There is no limit on how much we can improve what we start with. There is no limit on better.",
        "zh": "我们一开始拥有的东西提升空间无限，进步无止境。"
    },
    {
        "id": 77,
        "en": "Be prepared: When you have 90% of a large project completed finishing the final details will take another 90%. Houses and films are famous for having two 90%s.",
        "zh": "要有心理准备：一个大项目完成90%后，剩下的细节部分还需要再花90%的精力。盖房和拍电影都出了个“两次90%”的名。"
    },
    {
        "id": 78,
        "en": "Before you are old attend as many funerals as you can bear and listen. Nobody talks about the departed’s achievements. The only thing people will remember is what kind of person you were while you were achieving.",
        "zh": "在你年老之前，尽可能多参加葬礼，多倾听。没有人会谈论死者的成就，大家只会记得你成就时是什么样的人。"
    },
    {
        "id": 79,
        "en": "Anything real begins with the fiction of what could be. Imagination is therefore the most potent force in the universe. And you can get better at it. It’s the one skill in life that benefits from ignoring what everyone else knows.",
        "zh": "一切真实始于对可能性的幻想。想象力因此是宇宙中最强大的力量，而且你可以不断训练它。它是唯一一种无视世俗知识反而越强的技能。"
    },
    {
        "id": 80,
        "en": "When crises strike don’t waste them. No problems, no progress.",
        "zh": "当危机来临，不要浪费它。有问题才会有进步。"
    },
    {
        "id": 81,
        "en": "You really don’t want to be famous. Read the biography of any famous person.",
        "zh": "你其实不会想成名。读一读任何名人的传记就明白了。"
    },
    {
        "id": 82,
        "en": "On vacation go to the most remote place on your itinerary first bypassing the cities and then return to the big city at the end. You’ll maximize the shock of otherness in the remote, and then later you’ll welcome the familiar conveniences of a busy city on the way back.",
        "zh": "度假时先去最偏远的地方，绕开城市，最后再回大城市。这样你能最大程度地体会异域的冲击感，回程时又能重新欣赏城市的便利。"
    },
    {
        "id": 83,
        "en": "When you get invited to do something in the future ask yourself: Would I do this tomorrow? Not too many promises will pass that immediacy filter.",
        "zh": "当有人邀请你做未来的某事时，问问自己：我明天会干这事吗？很少有承诺能通过这种即时性的筛选。"
    },
    {
        "id": 84,
        "en": "Don’t say anything about someone in email you would not be comfortable saying to them directly because eventually it will reach them.",
        "zh": "不要在邮件里说你不敢当面说的话，因为这些话终会传到对方耳朵里。"
    },
    {
        "id": 85,
        "en": "If you ask to be hired mainly because you need a job you are just another problem for the boss; if you can solve many of the problems the boss has right now you are hired. To be hired, think like your boss.",
        "zh": "如果你只是因为需要工作而求职，你对于老板来说只是个新问题；如果你能解决老板现在头疼的问题，你就会被录用。想要被录用，要学会站在老板的角度思考。"
    },
    {
        "id": 86,
        "en": "It is not a compliment if it comes with a request.",
        "zh": "带请求的夸奖不是夸奖。"
    },
    {
        "id": 87,
        "en": "Art is in what you leave out.",
        "zh": "艺术在于你刻意省略了什么。"
    },
    {
        "id": 88,
        "en": "Acquiring things will rarely bring you deep satisfaction. But acquiring experiences will.",
        "zh": "拥有物品很难带来深刻的满足，但拥有体验却可以。"
    },
    {
        "id": 89,
        "en": "You are what you do. Not what you say not what you believe not how you vote but what you spend your time on.",
        "zh": "你就是你所做的事。不是你说什么、相信什么、如何投票，而是你把时间花在什么上。"
    },
    {
        "id": 90,
        "en": "Rule of 7 in research: You can find out anything if you are willing to go seven levels. If the first source you ask doesn’t know ask them who you should ask next and so on down the line. If you are willing to go to the seventh source you’ll almost always get your answer.",
        "zh": "研究的“七次法则”：愿意追问到第七层，你就能找到答案。如果第一个问的人不知道，就让他介绍下一个，依次类推。走到第七层，你几乎必定会有答案。"
    },
    {
        "id": 91,
        "en": "To earn bliss just for a moment send someone you don’t know a compliment for something they did.",
        "zh": "想要获得瞬间的幸福，就给一个陌生人为他们做的事情送去称赞。"
    },
    {
        "id": 92,
        "en": "When someone is nasty, hateful, or mean toward you treat their behavior like an affliction or illness they have. That makes it easier to have empathy toward them which can soften the conflict.",
        "zh": "如果有人对你刻薄、仇恨或恶意，把他们的行为当成一种疾病。这样你更容易有同理心，冲突也会被缓和。"
    },
    {
        "id": 93,
        "en": "Eliminating clutter makes room for your true treasures.",
        "zh": "清理杂物才能为真正的宝贝腾出空间。"
    },
    {
        "id": 94,
        "en": "Don’t ever respond to a solicitation or a proposal on the phone. The urgency is a disguise for a scam.",
        "zh": "永远别在电话中回应推销或邀约。所谓紧急不过是骗局的伪装。"
    },
    {
        "id": 95,
        "en": "Experience is overrated. Most breakthrough accomplishments were done by people doing them for the first time. Therefore when hiring hire for aptitude and attitude and then train for skills.",
        "zh": "经验被高估了。大多数突破性的成就都出自初次尝试的人。所以招聘时，先看天赋和态度，再培养技能。"
    },
    {
        "id": 96,
        "en": "How to apologize: quickly, specifically, sincerely. Don’t ruin an apology with an excuse.",
        "zh": "如何道歉：迅速、具体、真诚。不要用解释毁了你的道歉。"
    },
    {
        "id": 97,
        "en": "Don’t bother asking a barber if you need a haircut. Pay attention to incentives.",
        "zh": "别问理发师你需不需要理发。要关注他人的激励动机。"
    },
    {
        "id": 98,
        "en": "That thing that made you weird as a kid could make you great as an adult —if you don’t lose it.",
        "zh": "让你小时候与众不同的特质，若你不丢掉，它会让你在成年后变得伟大。"
    },
    {
        "id": 99,
        "en": "Following your bliss is a recipe for paralysis if you don’t know what you are passionate about. A better path for most youth is “master something.” Through mastery of one thing you’ll command a viewpoint to steadily find where your bliss is.",
        "zh": "如果你不知道自己热爱的是什么，仅仅追随幸福很容易陷入迷茫。对大多数年轻人来说，“把一件事做到极致”是更好的路径。通过精通某件事，你会逐步找到属于你的热爱。"
    },
    {
        "id": 100,
        "en": "To quiet a crowd or a drunk, just whisper.",
        "zh": "想平息人群或醉汉，只需低声细语。"
    },
    {
        "id": 101,
        "en": "When you lend something pretend you are gifting. If it is returned you’ll be surprised and happy.",
        "zh": "当你借东西给别人时，当作是在送人。如果归还了，你会惊喜又开心。"
    },
    {
        "id": 102,
        "en": "You are never too young to wonder “Why am I still doing this?” You need to have an excellent answer.",
        "zh": "无论多年轻，你都应该问自己“我为什么还在做这件事？”你要有一个很棒的答案。"
    },
    {
        "id": 103,
        "en": "A balcony or porch needs to be at least 6 feet (2 meters) deep or it won’t be used.",
        "zh": "阳台或门廊至少要有6英尺（2米）深，否则根本不会被使用。"
    },
    {
        "id": 104,
        "en": "Life gets better as you replace transactions with relationships.",
        "zh": "用关系取代交易，你的生活会越来越美好。"
    },
    {
        "id": 105,
        "en": "Investing small amounts of money over a long time works miracles but no one wants to get rich slow.",
        "zh": "长期定期小额投资能创造奇迹，但几乎没人愿意慢慢变富。"
    },
    {
        "id": 106,
    ...
    {
        "id": 107,
        "en": "When in doubt, overtip.",
        "zh": "犹豫时，就多给点小费。"
    },
    {
        "id": 108,
        "en": "To build strong children reinforce their sense of belonging to a family by articulating exactly what is distinctive about your family. They should be able to say with pride “Our family does X.”",
        "zh": "要培养坚强的孩子，就要强化他们对家庭的归属感——清楚地表达出家庭的独特之处。孩子们应该能够自豪地说“我们家就是……”。"
    },
    {
        "id": 109,
        "en": "If you are not embarrassed by your past self you have probably not grown up yet.",
        "zh": "如果你对过去的自己不感到羞愧，说明你还没有长大。"
    },
    {
        "id": 110,
        "en": "Outlaw the word “you” during domestic arguments.",
        "zh": "家庭争吵时禁止使用“你”这个词。"
    },
    {
        "id": 111,
        "en": "If you have any doubt at all about being able to carry a load in one trip do yourself a huge favor and make two trips.",
        "zh": "如果你对一次能否搬完有丝毫怀疑，请务必分两次搬，对自己好点。"
    },
    {
        "id": 112,
        "en": "Over the long term the future is decided by optimists. To be an optimist you don’t have to ignore the multitude of problems we create; you just have to imagine how much our ability to solve problems improves.",
        "zh": "长远来看，未来属于乐观者。要成为乐观者，并不意味着忽视问题，而是要相信我们解决问题的能力会不断进步。"
    },
    {
        "id": 113,
        "en": "Don’t let someone else’s urgency become your emergency. In fact, don’t be governed by the urgent of any sort. Focus on the important. The urgent is a tyrant. The important should be your king. Down with the tyranny of the urgent!",
        "zh": "不要让别人的紧急变成你的紧急。事实上，任何紧急的事都不该支配你。要聚焦重要事项，别让急迫的琐事奴役你，重要的才是你的王者。"
    },
    {
        "id": 114,
        "en": "Learn how to take a 20-minute power nap without embarrassment.",
        "zh": "学会无所顾忌地打个20分钟的充电小睡。"
    },
    {
        "id": 115,
        "en": "Paradoxically, the worst evils in the world are committed by those who truly believe they are combating evil. Be extremely vigilant with yourself when facing evil.",
        "zh": "矛盾的是，许多世界上最严重的罪恶，都是那些自认为在“与恶对抗”的人干出来的。面对“恶”时，务必要保持自省和警惕。"
    },
    {
        "id": 116,
        "en": "Don’t reserve you kindest praise for a person until their eulogy. Tell them while they are alive when it makes a difference to them Write it in a letter they can keep.",
        "zh": "不要把你最美好的赞美留到对方去世后才说。在他们还活着、听得见、能受益时说出来，写封信给他们留作回忆。"
    },
    {
        "id": 117,
        "en": "Fear is fueled by a lack of imagination. The antidote to fear is not bravery; it looks more like imagination.",
        "zh": "恐惧源于缺乏想象力。对抗恐惧的解药不是勇气，而是想象力。"
    },
    {
        "id": 118,
        "en": "Train employees well enough that they could get another job but treat them well enough that they never want to.",
        "zh": "把员工培养得有能力跳槽，同时善待他们，让他们根本不想跳槽。"
    },
    {
        "id": 119,
        "en": "If it fails where you thought it would fail that is not a failure.",
        "zh": "如果事情在你预想的环节失败了，那并不算失败。"
    },
    {
        "id": 120,
